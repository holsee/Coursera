...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(twt => google.exists(twt.text.contains))
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(twt => apple.exists(twt.text.contains))
